...
const TeamAssignment = ({ players = [], setPlayers }) => {
  ...
  // 勝敗を登録する関数
  const handleMatchResult = (winningTeam) => {
    ...
    localStorage.setItem('players', JSON.stringify(updatedPlayers)); // ローカルストレージに保存してプレイヤー一覧にも反映
  };
